    ...
    "proj-1780826710054": {
      ...
      "sections": {
        ...
        "challenge": {
          ...
          "content": "<p>Compass HR had 12 products already in market when I proposed building a shared design system in 2021. Leadership's response wasn't unreasonable: the products exist, teams are shipping, why disrupt something that's already standing?</p>\n\n<p>The objection came from the top , from our CEO down to the UX Design AVP. Their position was that it was too late. Starting a design system across mature products felt like expensive infrastructure work with \nuncertain return at exactly the wrong moment.</p>\n\n<p>That pushback forced a better argument than I originally had.</p>\n\n<p><strong> Getting buy-in</p></strong>\n\n<p>Rather than making the case in the abstract, I looked for proof inside the organization. One product team had already been working with a shared component approach informally, no infrastructure, no governance, just a shared Figma file. I documented their time savings, translated that into a cost figure, and extrapolated what that number would look like applied across all 12 products.</p>\n\n<p>I paired that internal proof with external benchmarking against established enterprise design systems to show what comparable organizations had built and what it cost them to not have one earlier.</p>\n\n<p>The result was a business case built on real numbers, not design theory. One quarter after the initial rejection, we had a green \nlight to proceed.</p>\n\n<p><strong> Governance</p></strong>\n<p>The system is now co-owned by two senior designers who maintain quality and consistency as the product portfolio grows.</p>\n\n<p>Contribution works through a reusability assessment: when a team needs something new, we evaluate whether that component has a realistic chance of being used across other products. If yes, it gets built into the system with full documentation and accessibility testing. If no, it stays at the product level, intentionally outside the system.</p>\n\n<p>That distinction matters. Not everything belongs in a design system. Knowing what to exclude is as important as knowing what to include.</p>",
          "image": ""
        },
        "problem": {
          "enabled": true,
